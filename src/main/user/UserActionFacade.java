...
//
///**
// * The Facade class that unifies all actions of the main.user currently using our program.
// */
//public class UserActionFacade {
//
//    /**
//     * Each of the following six use cases contain the concrete implementation of
//     * the methods that execute current main.user's action.
//     */
...
//
//    /**
//     * the main.user currently using our program.
//     */
...
//
//    /**
//     * Add a main.graph to currentUser.
//     * @param main.graph the main.graph being added
//     */
//    public void addGraphToCurrentUser(DirectedGraph main.graph) {
//        userManager.addGraphTo(currentUser, main.graph);
//    }
//
//    /**
...
//
//    /**
//     * download a main.resource for currentUser.
//     * @param resourceId the id of the main.resource currentUser is downloading.
//     */
...
//    }
//
//    public Map<String, DirectedGraph> getUserGraph(){
